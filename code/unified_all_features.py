...
for cv_loop_index, (train_index, test_index) in enumerate(kf):
    ...
    for trial in range(num_trials):
        ...
        train_region_train_df_transformed = transform_data(train_region_train_df_copy, transform)
...
out_path = os.path.expanduser("~/output/unified/unified_all_features_cv/")
