...
APPLIANCES=["dw",'hvac','fridge','wm','mw','oven']
        ...
        for appliance in APPLIANCES:
            ...
            for month in range(1,13):
                ...
                for test_home in test_df.index:
                    try:
                        store_path = '../../../output/output/ineq_cross_subset_kdd_25/%d_%s_%s_%s_%s_%d_%d_%d.pkl' %(
                                                                                                    num_homes,
                                                                                          train_region,
                                                                            test_region,
                                                                            transform,
