...
from code.regional_average_contribution import  contribution as contri
    ...
    for transform in TRANSFORMATIONS:
        ...
        #for appliance in ["hvac"]:
            ...
            for month in range(1,13):
                ...
                #
                acc[num_homes][transform][appliance][month] = pd.Series(out[num_homes][transform][appliance][month]).median()
    ...
    for month in range(1,13):
        ...
        for test_home in test_df.index:
            try:
                ...
                acc['Regional average'][appliance][month].append(error)
    ...
    for transform in TRANSFORMATIONS:
        ...
        for num_homes in range(5, 45, 5):
            ...
            for month in range(month_start, month_end):
                    w[appliance][transform][num_homes][month]=pd.Series(out[num_homes][transform][appliance][month]).dropna().median()
